...
public class DBService {
	...
	public void instantiateDatabase() {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "ruben.rtech@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, passwordEncoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "rubenrodriguesc@hotmail.com", "24363938005",
				TipoCliente.PESSOAFISICA, passwordEncoder.encode("159753"));
		cli2.getTelefones().addAll(Arrays.asList("44553344", "995566447"));
		cli2.addPerfil(Perfil.ADMIN);

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", c1, cli1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", c2, cli1);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "13170615", c2, cli2);
